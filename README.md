...
- [Events](#events)
  ...
  - [Transaction Package](#transaction-package)
    - [beforeParsing event](#beforeparsing-event)
    - [parsingCompleted event](#parsingcompleted-event)
    - [transactionLoaded event](#transactionloaded-event)
    - [transactionCreated event](#transactioncreated-event)
    - [transactionPackageSave event](#transactionpackagesave-event)
- [CLI](#cli)
